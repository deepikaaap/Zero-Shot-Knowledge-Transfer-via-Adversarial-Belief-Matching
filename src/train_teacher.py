...
if __name__ == '__main__':
    ...
    parser.add_argument('--saved_model', default='trained_teacher_weights/weights/WRN-40-2-0.h5', help='Prerun model for a few epochs, to continue further training if required')
